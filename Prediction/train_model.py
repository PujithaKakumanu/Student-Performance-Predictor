...
data = pd.read_csv(r'C:\Users\DELL\OneDrive\Desktop\SPP_ML\Prediction\Student Dataset.csv')  
data = data.drop(columns=['Unnamed: 14', 'Unnamed: 15', 'Ethnicity'], errors='ignore')
...
X = data[['Age', 'Gender', 'PYCGPA', 'ParentalEducation', 
